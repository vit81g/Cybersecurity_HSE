...
def print_help() -> None:
    ...
    print("-----------------------------------------------------------")
    print("Эта программа реализует блочный шифр 'Магма' согласно ГОСТ Р 34.12-2015.")
    print("Шифр работает с блоками данных по 64 бита (8 байт) и использует ключ длиной 256 бит (32 байта).")
    print("\nИспользование: python3 script.py [параметры]")
    print("Параметры:")
    ...
    print("   - Выберите режим работы: 'encrypt' для шифрования или 'decrypt' для расшифрования.")
    print("   - Укажите путь к входному файлу (например, plaintext.txt для шифрования или encrypted.bin для расшифрования).")
    print("   - Укажите путь к выходному файлу (например, encrypted.bin для шифрования или decrypted.txt для расшифрования).")
    print("   - Введите ключ шифрования в формате hex (256 бит, 64 символа).")
    print("\nПример ключа: 000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f")
    print("\nПример использования:")
    print("1. Для шифрования файла plaintext.txt в encrypted.bin:")
    print("   - Режим: encrypt")
    print("   - Входной файл: plaintext.txt")
    print("   - Выходной файл: encrypted.bin")
    print("   - Ключ: 000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f")
    print("2. Для расшифрования файла encrypted.bin в decrypted.txt:")
    print("   - Режим: decrypt")
    print("   - Входной файл: encrypted.bin")
    print("   - Выходной файл: decrypted.txt")
    print("   - Ключ: 000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f")
    print("\nПримечания:")
    print("- Убедитесь, что входной файл существует и доступен для чтения.")
    print("- Ключ должен быть в формате hex и содержать ровно 64 символа (32 байта).")
    print("- Для текстовых файлов используйте кодировку UTF-8, чтобы избежать проблем с русскими символами.")
    print("- Результат шифрования — бинарные данные, которые нельзя просматривать напрямую как текст.")
...
def main() -> None:
    ...
    while True:
        ...
        print("Пример ключа: 000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f")
