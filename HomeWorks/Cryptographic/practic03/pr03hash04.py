...
на языке Python. В коде приведены развернутые комментарии и описания функций.
Допускается использование готовой реализации хэш-функции ГОСТ Р 34.11-2012 или другой подходящей.
"""
